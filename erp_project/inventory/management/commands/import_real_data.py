...
class Command(BaseCommand):
    help = 'Import real data from CSV files into the ERP system'
    ...
    def handle(self, *args, **options):
        ...
        self.stdout.write(
            self.style.SUCCESS('Starting data import process...')
        )

        try:
            with transaction.atomic():
                # Step 1: Create storage zones and locations
                self.create_storage_infrastructure()
                
                # Step 2: Import suppliers
                self.import_suppliers()
                
                # Step 3: Import items and batches from stock files
    ...
    def create_receipt_transaction(self, item_record, supplier, batch, quantity, unit,
        ...
        transaction = InventoryTransaction.objects.create(
            ...
            product_code=batch.batch_number,
            ...
            comments=f'Imported from stock data - {batch.batch_number}'
        )
    ...
    def import_outgoing_transactions(self, filepath):
        ...
        # Similar to incoming but for outgoing transactions
        # This would create ISS-* type transactions
        pass 